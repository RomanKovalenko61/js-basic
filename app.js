/*
    ...
    - Наличие работы
    - Деньги
    Нужно проверить может ли он купить глвый MacBook за 2000$
    Он может брать не только свои деньги, но и взять кредит.
    Ему дадут 500$, только если ему больше 24-x лет и он
...
console.log(`Пользователь купит MacBook?: ${canBuy(2000, 25, 1500, true) ? 'Да' : 'Нет'}`);